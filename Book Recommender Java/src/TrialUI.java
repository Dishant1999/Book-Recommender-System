...
public class TrialUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label_1.setIcon(new ImageIcon("C:\\Users\\Owner\\Documents\\NetBeansProjects\\GUI\\images\\ui1.jpg"));
        ...
        Passwordicon.setIcon(new ImageIcon("C:\\Users\\Owner\\Documents\\NetBeansProjects\\GUI\\images\\password.png"));
        Passwordicon.setBounds(114, 235, 39, 38);
        getContentPane().add(Passwordicon);
        
        JLabel Usericon = new JLabel("");
        Usericon.setIcon(new ImageIcon("C:\\Users\\Owner\\Documents\\NetBeansProjects\\GUI\\images\\user.png"));
        Usericon.setBounds(114, 159, 55, 44);
        getContentPane().add(Usericon);
        
        txtPleaseLoginTo = new JTextField();
        txtPleaseLoginTo.setSelectedTextColor(SystemColor.activeCaption);
        ...
        txtPleaseLoginTo.setBackground(new Color(240, 240, 240));
